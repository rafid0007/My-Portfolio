export default {
  ...
  text: {
    ...
    heroSecondary: {
      color: 'white',
      fontSize: [2, 3, 4, '20px', null, 3, '24px', 4],
  ...
  buttons: {
    ...
    secondary_2: {
      ...
      mr: ['7px', null, null, '10px', '15px'],
    },
    techBtn:{
      variant: 'buttons.defaultBtn',
      border: '1.5px solid #25cb9e',
      backgroundColor: 'transparent',
      color: '#343d48',
      padding: ['7px 12px', null, null, null, '10px 15px'],
      mr: ['7px', null, null, '10px'],
      mt: '10px',
    },
    codeBtn: {
      variant: 'buttons.defaultBtn',
      padding: ['5px 10px', null, null, null, '5px 10px'],
      mr: ['7px', null, null, '10px'],
    },
    textButton: {
      variant: 'buttons.defaultBtn',
